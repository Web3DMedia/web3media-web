   ...
   return (
      <TeamSectionDiv >
         <div className="pt-4 w-full">
            ...
            <p className="hidden font-light sm:flex sm:flex-wrap sm:text-lg lg:text-[24px] lg:max-w-628 xl:text-[28px] text-white xl:max-w-[900px]">
               A team of highly motivated super heroes with super powers in designs, art, animation, engineering and product.
            </p>
            <p className="flex flex-wrap sm:hidden text-white text-[18px]">
         ...
         <div className="relative flex flex-col items-center justify-center w-full my-14 sm:my-16 md:my-20 h-600 lg:h-full md:p-28 lg:py-32">
            ...
            <div className="flex flex-col items-center w-28 h-20 absolute top-4 -left-2 sm:-top-8 md:-top-10 lg:-top-5 sm:left-auto">
               ...
               <h3 className="mt-1 text-white text-[14px] lg:text-[16px]">Engineering</h3>
            </div>
            ...
            <div className="flex flex-col items-center w-28 h-20 absolute top-4 -right-4 sm:top-1/2 sm:-right-5 md:-right-14  xl:right-0">
               ...
               <h3 className="mt-1 text-white text-[14px] lg:text-[16px]">Design</h3>
            </div>
            ...
            <div className="flex flex-col items-center w-28 h-20 absolute bottom-4 -left-2 sm:-bottom-8 md:-bottom-10 lg:-bottom-5 sm:left-auto">
               ...
               <h3 className="mt-1 text-white text-[14px] lg:text-[16px]">Animation</h3>
            </div>
            ...
            >
               ...
               <h3 className="mt-1 text-white text-[14px] lg:text-[16px]">Management</h3>
            </div>
